    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description: "group-[.toast]:text-zinc-400 group-[.toast]:text-xs group-[.toast]:font-normal group-[.toast]:mt-1",
          actionButton:
          ...
          title: "group-[.toast]:text-white group-[.toast]:font-medium group-[.toast]:text-sm group-[.toast]:leading-tight",
          icon: "group-[.toast]:text-zinc-400 group-[.toast]:w-4 group-[.toast]:h-4 group-[.toast]:mr-2",
          closeButton: "group-[.toast]:bg-transparent group-[.toast]:text-zinc-500 group-[.toast]:border-0 group-[.toast]:hover:bg-zinc-800 group-[.toast]:hover:text-zinc-300 group-[.toast]:w-5 group-[.toast]:h-5",
        },
      }}
